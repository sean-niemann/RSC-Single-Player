# RSC-Single-Player
RSC Single Player is a one player RuneScape Classic clone. You do not need any sort of internet connection what-so-ever to play. The client handles itself entirely and does not rely on a server.
