...
public class CollisionFlags {
    ...
    public static final int WALL_NORTH = 0x1;
    public static final int WALL_EAST = 0x2;
    public static final int WALL_SOUTH = 0x4;
    ...
    public static final int OBJECT = 0x80;
    ...
    public static final int SOURCE_SOUTH = 0x1;
    public static final int SOURCE_WEST = 0x2;
    public static final int SOURCE_NORTH = 0x4;
    public static final int SOURCE_EAST = 0x8;
