...
public class mudclient extends Shell {
    ...
    public void handleMouseScroll(int scroll) {
        ...
        if (loginScreen == 1) {
            ...
            panelSocialList.handleScroll(controlListSocialPlayers, scroll);
        } else if (showUiTab == 4) {
    ...
    private void drawUiTabOptions(boolean flag) {
        ...
        y += 15;
        if (musicStopped) {
            surface.drawString("Music (random) - @red@Stopped", x, y, 1, 0xffffff);
        } else {
            surface.drawString("Music (random) - @gre@Playing", x, y, 1, 0xffffff);
        }
        y += 15;
        y += 5;
