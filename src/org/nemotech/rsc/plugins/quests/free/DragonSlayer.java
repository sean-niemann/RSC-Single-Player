...
public class DragonSlayer implements QuestInterface,InvUseOnObjectListener,
    ...
    public boolean blockPlayerKilledNpc(Player p, NPC n) {
        if (n.getID() == 192 && p.getQuestStage(this) >= 2) {
            World.getWorld().registerItem(
                    new Item(416, n.getX(), n.getY(), 1, p));
        }
        if (n.getID() == 177) {
            World.getWorld().registerItem(
                    new Item(QuestItems.RED_KEY, n.getX(), n.getY(), 1, p));
        } else if (n.getID() == 178) {
            World.getWorld().registerItem(
                    new Item(QuestItems.ORANGE_KEY, n.getX(), n.getY(), 1, p));
        } else if (n.getID() == 179) {
            World.getWorld().registerItem(
                    new Item(QuestItems.YELLOW_KEY, n.getX(), n.getY(), 1, p));
        } else if (n.getID() == 180) {
            World.getWorld().registerItem(
                    new Item(QuestItems.BLUE_KEY, n.getX(), n.getY(), 1, p));
        } else if (n.getID() == 182) {
            World.getWorld().registerItem(
                    new Item(QuestItems.MAGENTA_KEY, n.getX(), n.getY(), 1, p));
        } else if (n.getID() == 181) {
            World.getWorld().registerItem(
                    new Item(QuestItems.BLACK_KEY, n.getX(), n.getY(), 1, p));
    ...
    public void handleReward(Player p) {
        ...
        p.incQuestExp(2, p.getMaxStat(2) * 300 + 1000);
        p.incQuestExp(1, p.getMaxStat(1) * 300 + 1000);
        p.incQuestPoints(2);
    }
    ...
    public void onWallObjectAction(GameObject obj, Integer click, Player p) {
        if (obj.getID() == 57) {
            if (p.getX() >= 259 && hasItem(p, 268, 1) && hasItem(p, 200, 1) && hasItem(p, 375, 1) && hasItem(p, 340)) {
                Point location = Point.getLocation(p.getX(), p.getY());
                doDoor(obj, p);
