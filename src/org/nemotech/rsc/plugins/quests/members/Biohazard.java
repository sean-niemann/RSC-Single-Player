...
import static org.nemotech.rsc.plugins.Plugin.closeCupboard;
...
import static org.nemotech.rsc.plugins.Plugin.openCupboard;
...
TalkToNpcExecutiveListener, WallObjectActionListener, WallObjectActionExecutiveListener, ObjectActionListener, ObjectActionExecutiveListener, InvUseOnObjectListener, InvUseOnObjectExecutiveListener, PlayerKilledNpcListener, PlayerKilledNpcExecutiveListener {
    ...
    public void handleReward(Player p) {
        ...
        p.incQuestPoints(3);
        p.incQuestExp(THIEVING, (p.getMaxStat(THIEVING) * 50) + 500);
        ...
        if(n.getID() == KING_LATHAS) {
            ...
            if(p.getQuestStage(this) == -1) {
                ...
                case 2:
                    ...
                    if(p.getQuestStage(Plugin.UNDERGROUND_PASS) == 0) {
                        p.updateQuestStage(Plugin.UNDERGROUND_PASS, 1);
                    }
                    break;
                case 3:
                case 4:
                ...
                case 7:
                    ...
                    p.sendQuestComplete(Plugin.UNDERGROUND_PASS);
                    break;
                case -1:
                    playerTalk(p,n, "hello king lathas");
            ...
            if(p.getQuestStage(this) == 9) {
                ...
                if(menu == 0) {
                    ...
                    addItem(p, 826, 1);
                    p.sendQuestComplete(Plugin.BIOHAZARD);
                } else if(menu == 1) {
    ...
    private void ropeLadderBackFunction(final Player p) {
        GameObject ropeLadder = new GameObject(Point.getLocation(622, 611), VISUAL_ROPELADDER, 0, 0);
