...
public class Observatory extends Plugin implements QuestInterface,TalkToNpcListener,
    ...
    public void handleReward(Player p) {
        ...
        p.incQuestPoints(2);
        p.incQuestExp(12, (p.getMaxStat(12) * 100) + 250);
    ...
    public void onObjectAction(GameObject obj, String command, Player p) {
        ...
        if (obj.getID() == 937) {
            ...
            World.getWorld().replaceGameObject(obj, new GameObject(obj.getLocation(), 936, obj.getDirection(), obj.getType()));
        }
        if (obj.getID() == 936) {
            ...
            if (p.getQuestStage(getQuestID()) == 6) {
                ...
                if(professor != null) {
                    ...
                    if (telescop == 0) {
                        ...
                        p.sendQuestComplete(OBSERVATORY_QUEST);
    ...
    private void constellationNameAndReward(Player p, NPC n) {
        switch (selectedNumber) {
            case 0:
                npcTalk(p, n, "Virgo the virtuous", "you are granted an increase in defense");
                p.incQuestExp(1, 875);
                break;
            case 1:
                npcTalk(p, n, "Libra the scales", "The scales of justice award you with Law Runes");
                addItem(p, 42, 3);
                break;
            case 2:
                npcTalk(p, n, "Gemini the twins", "The double nature of Gemini awards you a two-handed weapon");
                addItem(p, 426, 1);
                break;
            case 3:
            ...
            case 5:
                ...
                break;
            case 6:
                npcTalk(p, n, "Scorpio the scorpion", "The scorpion gives you poison from it's sting");
                addItem(p, 572, 1);
                break;
            case 7:
                npcTalk(p, n, "Aries the ram", "you are granted an increase in attack");
                p.incQuestExp(0, 875);
                addItem(p, 160, 1);
                break;
            case 8:
                ...
                break;
            case 9:
                npcTalk(p, n, "Leo the lion", "you are granted an increase in hits");
                p.incQuestExp(3, 875);
                break;
            case 10:
                npcTalk(p, n, "Capricorn the goat", "you are granted an increase in strength");
                p.incQuestExp(2, 875);
                break;
            case 11:
