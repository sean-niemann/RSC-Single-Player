...
public class ClockTower extends Plugin implements QuestInterface,TalkToNpcListener,
        ...
        if (n.getID() == 366) {
            ...
            case 1:
                if (p.getCache().hasKey("1st_cog")
                    ...
                    p.sendQuestComplete(CLOCK_TOWER);
                    return;
                }
    ...
    public void onObjectAction(GameObject obj, String command, Player p) {
        ...
        if (obj.getID() == 373 || obj.getID() == 374) {
            if (closed) {
                ...
                GameObject firstGate = new GameObject(obj.getID() == 373 ? Point.getLocation(594, 3475) : Point.getLocation(590, 3475), 372, 0, 0);
                ...
                GameObject secondGate = new GameObject(
                        obj.getID() == 373 ? Point.getLocation(594, 3475) : Point
                                .getLocation(590, 3475), 371, 0, 0);
    ...
    public void onWallObjectAction(GameObject obj, Integer click, Player p) {
        if (obj.getID() == 111) {
            if (p.getCache().hasKey("rats_dead") || atQuestStage(p, this, -1)) {
                ...
                if (p.getX() >= 583) {
                    p.setLocation(Point.getLocation(582, 3476), true);
                } else {
                    p.setLocation(Point.getLocation(583, 3476), true);
                }
            }
        }
        if (obj.getID() == 22 && obj.getX() == 584 && obj.getY() == 3457) {
    ...
    @Override
    public boolean blockInvUseOnGroundItem(InvItem myItem, Item item, Player p) {
