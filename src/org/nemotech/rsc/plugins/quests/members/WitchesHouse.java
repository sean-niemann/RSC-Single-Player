...
public class WitchesHouse extends Plugin implements QuestInterface, TalkToNpcListener,
    ...
    /**
     * INFORMATION Rat appears on coordinates: 356, 494 Dropping cheese in the whole
     * room and rat appears on the same coordinate Rat is never removed until you
    ...
    public void handleReward(Player p) {
        ...
        p.incQuestExp(3, p.getMaxStat(3) * 125 + 200);
        ...
        if (n.getID() == 240) {
            ...
            case 3:
                if (hasItem(p, 539)) {
                    ...
                    removeItem(p, 539, 1);
                    if(p.getQuestStage(WITCHS_HOUSE) == 3) {
                        p.sendQuestComplete(WITCHS_HOUSE);
                    }
                } else {
        ...
        if (obj.getID() == 72 && obj.getX() == 356) {
            if (p.getX() <= 355) {
                ...
                if (p.getCache().hasKey("witch_spawned")) {
                    ...
                    witch.teleport(353, 492);
                    witch.setLocation(Point.getLocation(353, 492), true);
                    message(p,
    ...
    public void onPlayerKilledNpc(Player p, NPC n) {
        ...
        n.killedBy(p);
        NPC nextShape = spawnNpc(n.getID() + 1, p.getX(), p.getY(), 300000);
