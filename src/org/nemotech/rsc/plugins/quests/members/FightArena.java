...
public class FightArena extends Plugin implements QuestInterface,TalkToNpcListener,
...
PlayerKilledNpcExecutiveListener {
    ...
    public void handleReward(Player p) {
        ...
        p.incQuestExp(0, p.getMaxStat(0) * 200 + 175);
        p.incQuestExp(17, p.getMaxStat(17) * 200 + 175);
    ...
    public void onTalkToNpc(Player p, NPC n) {
        ...
        if (n.getID() == 372) {
            ...
            case 3:
                ...
                p.sendQuestComplete(FIGHT_ARENA);
                break;
            case -1:
                playerTalk(p, n, "Hello lady Servil");
